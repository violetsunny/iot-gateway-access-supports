 ...
 */
@Slf4j
public class GpswvMileageProtocol extends AbstractProtocol {
    @Override
    public String getId() {
        return "gpswv-mileage";
    }
    ...
    public List<? extends Message> decodeMulti(byte[] messageBytes, Object... params) throws DecodeMessageException {
        ...
        JSONArray jsonArray = req.getJSONArray("deviceList");
        if(CollectionUtils.isEmpty(jsonArray)){
            log.warn("deviceList数据为空 {}",req.toJSONString());
            return requests;
        }
